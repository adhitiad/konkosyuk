...
export const cleanupExpiredBookingsQueue = new Queue(
...
export const completeExpiredBookingsQueue = new Queue(
...
export const referralEligibilitySweepQueue = new Queue(
...
export const churnPredictionQueue = new Queue("churn-prediction", {
  connection: getSharedRedisConnection(),
  defaultJobOptions: {
    removeOnComplete: { count: 50 },
    removeOnFail: { count: 0 },
