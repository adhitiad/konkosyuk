...
const areas = [
  ...
  },
  {
    slug: "undip-semarang",
    name: "UNDIP Semarang",
    imageKey: "konkosyuk/campus/undip",
    sortOrder: 2,
  },
  {
    slug: "ui-depok",
  ...
  {
    slug: "unpad-jatinangor",
    name: "UNPAD Jatinangor",
    imageKey: "konkosyuk/campus/unpad",
    sortOrder: 4,
  },
  {
    slug: "itb-bandung",
    name: "ITB Bandung",
    imageKey: "konkosyuk/campus/itb",
    sortOrder: 5,
  },
  {
    slug: "ub-jakarta",
    name: "UB Jakarta",
    imageKey: "konkosyuk/campus/ub",
    sortOrder: 6,
  },
  {
    slug: "uai-yogyakarta",
    name: "UAI Yogyakarta",
    imageKey: "konkosyuk/campus/uai",
    sortOrder: 7,
  },
  {
    slug: "unair-surabaya",
    name: "UNAIR Surabaya",
    imageKey: "konkosyuk/campus/unair",
    sortOrder: 8,
  },
  {
    slug: "um-malang",
    name: "UM Malang",
    imageKey: "konkosyuk/campus/um",
    sortOrder: 9,
  },
  {
    slug: "usn-jakarta",
    name: "USN Jakarta",
    imageKey: "konkosyuk/campus/usn",
    sortOrder: 10,
  },
  {
    slug: "uin-malang",
    name: "UIN Malang",
    imageKey: "konkosyuk/campus/uin",
    sortOrder: 11,
  },
  {
    slug: "uin-suka",
    name: "UIN Sunan Kalijaga",
    imageKey: "konkosyuk/campus/uin-suka",
    sortOrder: 12,
  },
];
...
async function seed() {
  ...
  for (const area of areas) {
    const [existing] = await db
      .select()
      .from(campusAreas)
      .where(eq(campusAreas.slug, area.slug))
      .limit(1);
    if (existing) {
