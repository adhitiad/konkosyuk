...
const packages = [
  {
    ...
    duration: 3,
    price: "34900",
    positionType: "rotation" as const,
    sortOrder: 1,
  },
  {
    name: "reguler_7d",
    label: "Reguler 1 Minggu",
    tier: "reguler" as const,
    duration: 7,
    price: "59900",
    positionType: "rotation" as const,
  ...
  },
  {
    ...
    duration: 3,
    price: "89900",
    positionType: "fixed_2" as const,
    sortOrder: 1,
  },
  {
    name: "utama_7d",
    label: "Utama 1 Minggu",
    tier: "utama" as const,
    duration: 7,
    price: "149900",
    positionType: "fixed_2" as const,
  ...
  {
    name: "premium_3d",
    label: "Premium 3 Hari",
    tier: "premium" as const,
    duration: 3,
    price: "174900",
    positionType: "fixed_1" as const,
    sortOrder: 1,
  },
  {
    name: "premium_7d",
...
async function seed() {
  ...
  for (const pkg of packages) {
    const [existing] = await db
      .select()
      .from(adPackages)
      .where(eq(adPackages.name, pkg.name))
      .limit(1);
    if (existing) {
