...
export default function ProfileSettingsPage() {
  ...
  // Use query data directly instead of local state to avoid set-state-in-effect lint warnings
  const resolvedProvinces = provincesData ?? [];
  const resolvedCities = citiesData ?? [];
  const resolvedDistricts = districtsData ?? [];

  // Reset city/district when province changes via Select handler
