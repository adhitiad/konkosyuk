  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "sticky top-0 flex h-screen w-(--sidebar-width) flex-col bg-sidebar/90 backdrop-blur-xl border-r border-white/10 text-sidebar-foreground",
          className,
        )}
        {...props}
      >
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar/90 backdrop-blur-xl group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
