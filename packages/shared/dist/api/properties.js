import { z } from "zod";
import { PROPERTY_TYPES, UNIT_STATUSES, PROPERTY_STATUSES, SEASONAL_RULE_TYPES, } from "../constants/enums";
...
const propertyPackagesSchema = z.object({
...
export const updateSeasonalPricingRuleSchema = seasonalPricingRuleSchema.partial();
