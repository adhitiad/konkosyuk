...
function SunIcon() {
  return (
    ...
    >
      <path d="M16.9991 12C16.9991 14.7614 14.7605 17 11.9991 17C9.23766 17 6.99908 14.7614 6.99908 12C6.99908 9.23858 9.23766 7 11.9991 7C14.7605 7 16.9991 9.23858 16.9991 12Z" />
...
export function ThemeSwitcher() {
  ...
  const Icon =
    theme === "light" ? SunIcon : theme === "dark" ? MoonIcon : SparklesIcon;
