export const MAP_STYLES = {
  ...
  CARTODB_VOYAGER: "https://basemaps.cartocdn.com/gl/voyager-gl-style/style.json",
  CARTODB_POSITRON: "https://basemaps.cartocdn.com/gl/positron-gl-style/style.json",
};
