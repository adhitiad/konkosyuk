    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <HugeiconsIcon icon={Clock01Icon} strokeWidth={2} className="size-5 text-orange-500" />
              Sedang Diverifikasi
            </CardTitle>
          </CardHeader>
          <CardContent>
      ...
      {kycStatus === 'rejected' && (
        <Card className="mt-4">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <HugeiconsIcon icon={Cancel01Icon} strokeWidth={2} className="size-5 text-red-500" />
              Verifikasi Ditolak
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Verifikasi KYC Anda ditolak. Silakan upload ulang KTP dengan data yang jelas dan valid.
            </p>
          </CardContent>
        </Card>
      )}
