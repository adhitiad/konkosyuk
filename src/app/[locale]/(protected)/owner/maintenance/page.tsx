...
export default function OwnerMaintenancePage() {
  ...
  const [selectedTicket, setSelectedTicket] = useState<MaintenanceTicketWithNames | null>(null)
  ...
  return (
    <div className="container py-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Kelola tiket kerusakan dari tenant</p>
      </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Select<string> value={statusFilter} onValueChange={(v) => setStatusFilter(v ?? 'all')}>
                ...
                <TableBody>
                  {tickets.map((ticket: MaintenanceTicketWithNames) => (
                    <TableRow key={ticket.id}>
                      ...
                      <TableCell>{ticket.unitName ?? ticket.unitId.slice(0, 8)}</TableCell>
          ...
          {selectedTicket && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select<string> value={newStatus} onValueChange={(v) => v && setNewStatus(v)}>
