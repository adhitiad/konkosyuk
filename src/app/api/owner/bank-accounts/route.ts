  ...
  try {
    ...
    if (normalize(user.name) !== normalize(body.account_name)) {
      return NextResponse.json(
        {
          error: 'Nama rekening tidak sesuai dengan nama profil KonkosYuk Anda. Silakan perbarui nama profil Anda terlebih dahulu di halaman Pengaturan Profil agar sesuai dengan KTP/Buku Tabungan.',
          code: 'NAME_MISMATCH',
        },
        { status: 400 },
      )
